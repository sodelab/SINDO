...
!      Nfree=Nat3-6
  ...
  END SUBROUTINE RNWCHEM_Const
!
!---+----1----+----2----+----3----+----4----+----5----+----6----+----7----+----8
!
  SUBROUTINE RNWCHEM_Dest()
  ...
  END SUBROUTINE RNWCHEM_Dest
!
!---+----1----+----2----+----3----+----4----+----5----+----6----+----7----+----8
!
  SUBROUTINE RNWCHEM_Label(x)
...
! -----------------------------------------------------------------------------
  ...
  END SUBROUTINE RNWCHEM_Label
!
!---+----1----+----2----+----3----+----4----+----5----+----6----+----7----+----8
!
  SUBROUTINE RNWCHEM_Freq(Omega)
...
! -----------------------------------------------------------------------------
 ...
 10 Continue
  ...
  END SUBROUTINE RNWCHEM_Freq
!
!---+----1----+----2----+----3----+----4----+----5----+----6----+----7----+----8
!
  SUBROUTINE RNWCHEM_Geom(x)
...
! -----------------------------------------------------------------------------
  ...
  END SUBROUTINE RNWCHEM_Geom
!
!---+----1----+----2----+----3----+----4----+----5----+----6----+----7----+----8
!
  SUBROUTINE RNWCHEM_Grad(x)
...
! -----------------------------------------------------------------------------
  ...
  END SUBROUTINE RNWCHEM_Grad
!
!---+----1----+----2----+----3----+----4----+----5----+----6----+----7----+----8
!
  SUBROUTINE RNWCHEM_Hess(H)
...
! -----------------------------------------------------------------------------
  ...
  END SUBROUTINE RNWCHEM_Hess
!
!---+----1----+----2----+----3----+----4----+----5----+----6----+----7----+----8
 
!
  SUBROUTINE RNWCHEM_L(CL)
...
! -----------------------------------------------------------------------------
 ...
 10 Continue
  ...
  END SUBROUTINE RNWCHEM_L
!
!---+----1----+----2----+----3----+----4----+----5----+----6----+----7----+----8
!
! Dipole moment vector in Debye
!
  SUBROUTINE RNWCHEM_Dpl(x)
...
! -----------------------------------------------------------------------------
  ...
  END SUBROUTINE RNWCHEM_Dpl
!
!---+----1----+----2----+----3----+----4----+----5----+----6----+----7----+----8
!
  SUBROUTINE RNWCHEM_Mass(x)
...
!
  SUBROUTINE RNWCHEM_MO(iopt,n,eig,vec)
...
! -----------------------------------------------------------------------------
  ...
  END SUBROUTINE RNWCHEM_MO
!
!---+----1----+----2----+----3----+----4----+----5----+----6----+----7----+----8
!
  FUNCTION RNWCHEM_Ene(opt)
...
! -----------------------------------------------------------------------------
    ...
    Double Precision :: RNWCHEM_Ene
      ...
      Open(ii,file='energy',status='old',err=1000)
...
! -----------------------------------------------------------------------------
  ...
  End FUNCTION RNWCHEM_Ene
!
!---+----1----+----2----+----3----+----4----+----5----+----6----+----7----+----8


  Subroutine RNWCHEM_setLinear(option)
